...
namespace WodiLib.SourceGenerator.Domain.Container.Generation
{
    /// <summary>
    ...
    internal static class GenerationConst
    {
        ...
        private static string RootNameSpace => $"{Core.Generation.GenerationConst.RootNameSpace}.Domain.Container";
