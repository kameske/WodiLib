        ...
        private protected override SourceFormatTargetBlock GenerateTypeDefinitionSource(WorkState workState)
        {
            ...
            return SourceTextFormatter.Format("",
                ...
                SourceTextFormatter.If(isImplementDeepCloneableList, new[]
                {
                    ...
                    $"",
                    $"{__}{interfaceName} {interfaceName}.DeepCloneWith(int? length) => DeepCloneWith(length);",
                    $"{__}{interfaceName} Sys.Collections.IDeepCloneableList<{interfaceName}, {interfaceInItemType}>.DeepCloneWith(int? length) => DeepCloneWith(length);",
                    $"{__}{fixedLengthInterfaceName} {fixedLengthInterfaceName}.DeepCloneWith(int? length) => DeepCloneWith(length);",
                    $"{__}{fixedLengthInterfaceName} Sys.Collections.IDeepCloneableList<{fixedLengthInterfaceName}, {interfaceInItemType}>.DeepCloneWith(int? length) => DeepCloneWith(length);",
                    $"{__}{readOnlyInterfaceName} Sys.Collections.IDeepCloneableList<{readOnlyInterfaceName}, {interfaceInItemType}>.DeepCloneWith(int? length) => DeepCloneWith(length);",
                    $"",
                    $"{__}{interfaceName} {interfaceName}.DeepCloneWith<TItem>(System.Collections.Generic.IReadOnlyDictionary<int, TItem>? values, int? length) => DeepCloneWith(values, length);",
                    $"{__}{interfaceName} Sys.Collections.IDeepCloneableList<{interfaceName}, {interfaceInItemType}>.DeepCloneWith<TItem>(System.Collections.Generic.IReadOnlyDictionary<int, TItem>? values, int? length) => DeepCloneWith(values, length);",
                    $"{__}{fixedLengthInterfaceName} {fixedLengthInterfaceName}.DeepCloneWith<TItem>(System.Collections.Generic.IReadOnlyDictionary<int, TItem>? values, int? length) => DeepCloneWith(values, length);",
                    $"{__}{fixedLengthInterfaceName} Sys.Collections.IDeepCloneableList<{fixedLengthInterfaceName}, {interfaceInItemType}>.DeepCloneWith<TItem>(System.Collections.Generic.IReadOnlyDictionary<int, TItem>? values, int? length) => DeepCloneWith(values, length);",
                    $"{__}{readOnlyInterfaceName} Sys.Collections.IDeepCloneableList<{readOnlyInterfaceName}, {interfaceInItemType}>.DeepCloneWith<TItem>(System.Collections.Generic.IReadOnlyDictionary<int, TItem>? values, int? length) => DeepCloneWith(values, length);",
                }),
                new[]
                {
                    $"}}",
