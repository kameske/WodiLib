...
namespace WodiLib.Test.Ini.ValueObject
{
    ...
    public class ProxyAddressTest
    {
        ...
        {
            var leftIndex = (ProxyAddress) left;
            var rightIndex = (ProxyAddress) right;
        ...
        {
            var target = (ProxyAddress) "127.127.127.127";
