...
namespace WodiLib.Test.Map
{
    ...
    public class MapEventNameTest
    {
        ...
        {
            var instance = new MapEventName(value);
        ...
        {
            var leftIndex = (MapEventName) left;
