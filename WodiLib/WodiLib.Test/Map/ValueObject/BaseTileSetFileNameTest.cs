...
{
    [TestFixture]
    public class BaseTileSetFileNameTest
    {
        ...
        public static void ConstructorTest(string value, bool isError)
        {
            ...
            try
            {
                var _ = new BaseTileSetFileName(value);
            }
            catch (Exception ex)
            {
                logger.Exception(ex);
        ...
        {
            var instance = new BaseTileSetFileName(value);
        ...
        {
            BaseTileSetFileName instance = null;
        ...
        {
            var target = (BaseTileSetFileName) "filePath";
