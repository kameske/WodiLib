...
{
    [TestFixture]
    public class DatabaseValueCaseDescriptionTest
    {
        ...
        public static void ConstructorTest(string value, bool isError)
        {
            ...
            try
            {
                var _ = new DatabaseValueCaseDescription(value);
            }
            catch (Exception ex)
            {
                logger.Exception(ex);
        ...
        {
            var instance = new DatabaseValueCaseDescription(value);
        ...
        {
            DatabaseValueCaseDescription instance = null;
        ...
        {
            var leftIndex = (DatabaseValueCaseDescription) left;
            var rightIndex = (DatabaseValueCaseDescription) right;
        ...
        {
            var target = (DatabaseValueCaseDescription) "description";
