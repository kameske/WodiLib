...
{
    [TestFixture]
    public class DBValueStringTest
    {
        ...
        {
            var instance = new DBValueString(value);
        ...
        {
            var leftIndex = (DBValueString) left;
            var rightIndex = (DBValueString) right;
        ...
        {
            var target = (DBValueString) "StringItem";
