...
{
    [TestFixture]
    public class MapTreeOpenStatusDataFileReaderTest
    {
        ...
        [Test]
        public static void MapTree0Test()
        {
            Common(
                MapTreeOpenStatusDataFileItemGenerator.GenerateData0(),
                @"Dir0\MapTreeOpenStatus.dat");

            Assert.True(true);
        }

        private static void Common(MapTreeOpenStatusData resultData, string readFileName)
        {
