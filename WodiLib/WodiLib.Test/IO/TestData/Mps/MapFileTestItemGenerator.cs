                ...
                MapEvents = new MapEventList(
                    new List<MapEvent>
                    {
                        ...
                        new()
                        {
                            ...
                            MapEventPageList = new MapEventPageList(
                                new List<MapEventPage>
                                {
                                    // マップイベント00 - ページ1
                                    new()
                                    {
                                        ...
                                        HitExtendRange = new HitExtendRange { Width = 4, Height = 2 },
                                        ShadowGraphicId = 1,
                                        // イベントコマンド
                            ...
                            MapEventPageList = new MapEventPageList(
                                new[]
                                {
                                    new MapEventPage
                                    {
                                        ...
                                        HitExtendRange = new HitExtendRange { Width = 1, Height = 3 },
                                        ShadowGraphicId = 2,
                                        EventCommands = new EventCommandList(
                                            new[]
                                            {
                                                ...
                                                EventCommandFactory.CreateCommandString(
                                                    @"[121][4,0]<0>(2000003,30,400,17154)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[121][5,0]<0>(2000004,30,400,87057,3)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[121][4,0]<0>(2000004,30,400,25944)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[121][4,0]<0>(2000004,30,40,1536)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[121][4,0]<0>(2000004,30,40,1792)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[121][4,0]<0>(2000004,30,40,2048)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[121][4,0]<0>(2000004,30,40,63744)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[121][4,0]<0>(2000004,30,40,2560)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[121][4,0]<0>(2000004,30,40,2816)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                ...
                                                EventCommandFactory.CreateCommandString(
                                                    @"[122][2,1]<0>(9900000,0)(""文字列入力"")"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[122][3,0]<0>(2000002,273,9900000)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[122][3,0]<0>(9900002,4611,15)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[122][3,0]<0>(3000000,8963,15)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[122][3,0]<0>(3000002,1026,2000010)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[122][3,0]<0>(3000002,1281,9900000)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[122][3,0]<0>(3000002,1537,9900000)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[122][3,0]<0>(3000002,1793,9900000)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[122][3,0]<0>(3000002,2049,9900000)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[122][2,2]<0>(3000002,2304)(""文字列入力"",""置換先"")"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[122][2,1]<0>(3000002,2560)(""文字列入力"")"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[122][2,1]<0>(3000002,2816)(""文字列入力"")"
                                                ),
                            ...
                            MapEventPageList = new MapEventPageList(
                                new[]
                                {
                                    new MapEventPage
                                    {
                                        ...
                                        HitExtendRange = new HitExtendRange { Width = 0, Height = 0 },
                                        ShadowGraphicId = 0,
                                        EventCommands = new EventCommandList(
                                            new[]
                                            {
                ...
                MapEvents = new MapEventList(
                    new[]
                    {
                            ...
                            MapEventPageList = new MapEventPageList(
                                new[]
                                {
                                    new MapEventPage
                                    {
                                        ...
                                        HitExtendRange = new HitExtendRange { Width = 4, Height = 4 },
                                        ShadowGraphicId = 0,
                                        EventCommands = new EventCommandList(
                                            new[]
                                            {
                                    ...
                                    new MapEventPage
                                    {
                                        ...
                                        EventCommands = new EventCommandList(
                                            ...
                                            {
                                                EventCommandFactory.CreateCommandString(
                                                    @"[123][2,0]<0>(2000000,241)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(@"[123][2,0]<0>(2000000,4)()"),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[123][3,0]<0>(2000000,260,100)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[123][3,0]<0>(2000000,4356,130)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[123][2,0]<0>(2000000,864)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[123][2,0]<0>(2000000,770)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[123][3,0]<0>(2000000,514,301)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[123][3,0]<0>(2000000,4610,301)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(@"[125][1,0]<0>(226)()"),
                                                EventCommandFactory.CreateCommandString(@"[125][1,0]<0>(21)()"),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[125][2,0]<0>(268435456,122)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(@"[125][1,0]<0>(536870915)()"),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[125][3,0]<0>(536870933,3,0)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[125][3,0]<0>(536870925,20,400)()"
                                                ),
                                    ...
                                    new MapEventPage
                                    {
                                        ...
                                        EventCommands = new EventCommandList(
                                            new[]
                                            {
                                                ...
                                                EventCommandFactory.CreateCommandString(
                                                    @"[150][4,0]<0>(33559042,100,11,22)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[150][2,0]<0>(33559043,100)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(@"[0][0,0]<0>()()")
                                            }
                                        )
                                    ...
                                    new MapEventPage
                                    {
                                        ...
                                        HitExtendRange = new HitExtendRange { Width = 1, Height = 4 },
                                        ShadowGraphicId = 1,
                                        EventCommands = new EventCommandList(
                                            new[]
                                            {
                                                EventCommandFactory.CreateCommandString(
                                                    @"[290][7,0]<0>(0,10,10,10,40,50,60)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[290][7,0]<0>(16,10,10,20,40,50,60)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[290][7,0]<0>(32,1100003,2000000,2000001,1100000,1100001,1100002)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[290][7,0]<0>(48,40,3,3,10,20,30)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[290][7,0]<0>(64,40,3,3,10,20,30)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[290][7,0]<0>(80,40,3,3,10,20,30)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[290][7,0]<0>(96,40,3,3,10,20,30)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[290][7,0]<0>(112,40,3,3,10,20,30)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[290][7,0]<0>(128,40,3,3,10,20,30)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[290][7,0]<0>(144,40,3,3,10,20,30)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[290][7,0]<0>(160,40,3,3,10,20,30)()"
                                                ),
                                    ...
                                    new MapEventPage
                                    {
                                        ...
                                        EventCommands = new EventCommandList(
                                            new[]
                                            {
                                                ...
                                                EventCommandFactory.CreateCommandString(
                                                    @"[140][4,0]<0>(16777216,5,2000040,2)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[140][4,0]<0>(16777232,5,2000002,2)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[140][4,0]<0>(16777248,5,1100003,2)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[140][7,1]<0>(33554433,0,0,0,105,100,20)(""BGM/bgm.mp3"")"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[140][4,0]<0>(16776960,0,0,0)()"
                                                ),
                                    ...
                                    new MapEventPage
                                    {
                                        ...
                                        EventCommands = new EventCommandList(
                                            new[]
                                            {
                                                ...
                                                EventCommandFactory.CreateCommandString(
                                                    @"[221][4,0]<0>(1100005,7,1100000,0)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[221][4,0]<0>(2500000,1,2000900,1)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[222][4,0]<0>(1100000,1,2000000,0)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[222][4,0]<0>(31,5,1024000000,1)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(@"[0][0,0]<0>()()")
                                            }
                                        )
                            ...
                            MapEventPageList = new MapEventPageList(
                                new[]
                                {
                                    new MapEventPage
                                    {
                                        ...
                                        HitExtendRange = new HitExtendRange { Width = 1, Height = 0 },
                                        ShadowGraphicId = 2,
                                        EventCommands = new EventCommandList(
                                            new[]
                                            {
                        ...
                        new MapEvent
                        {
                            EventName = "イベント",
                            MapEventId = 3,
                            Position = new Position { X = 10, Y = 6 },
                            MapEventPageList = new MapEventPageList(
                                new[]
                                {
                                    new MapEventPage
                                    {
                                        ...
                                        EventCommands = new EventCommandList(
                                            new[]
                                            {
                                                ...
                                                EventCommandFactory.CreateCommandString(
                                                    @"[130][5,0]<0>(-1,6,8,-1,17)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[130][5,0]<0>(-10001,5,0,0,33)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[130][5,0]<0>(-2,6,8,0,16)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[130][5,0]<0>(2,1100000,1100001,0,0)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(
                                                    @"[130][5,0]<0>(1100002,3,5,0,16)()"
                                                ),
                                                EventCommandFactory.CreateCommandString(@"[0][0,0]<0>()()")
                                            }
                                        )
                            ...
                            MapEventPageList = new MapEventPageList(
                                new[]
                                {
                                    new MapEventPage
                                    {
                                        ...
                                        HitExtendRange = new HitExtendRange { Width = 2, Height = 2 },
                                        ShadowGraphicId = 0,
                                        EventCommands = new EventCommandList(
                                            new[]
                                            {
                            ...
                            MapEventPageList = new MapEventPageList(
                                new[]
                                {
                                    new MapEventPage
                                    {
                                        ...
                                        HitExtendRange = new HitExtendRange { Width = 1, Height = 2 },
                                        ShadowGraphicId = 0,
                                        EventCommands = new EventCommandList(
                                            new[]
                                            {
