...
{
    [TestFixture]
    public class CommonEventResultDescriptionTest
    {
        ...
        public static void ConstructorTest(string value, bool isError)
        {
            ...
            try
            {
                var _ = new CommonEventResultDescription(value);
            }
            catch (Exception ex)
            {
                logger.Exception(ex);
        ...
        {
            var instance = new CommonEventResultDescription(value);
        ...
        public static void CastToStringTest(string value)
        {
            ...
            var instance = value != null
                ? new CommonEventResultDescription(value)
                : null;
        ...
        {
            CommonEventResultDescription instance = null;
        ...
        {
            var leftIndex = (CommonEventResultDescription) left;
            var rightIndex = (CommonEventResultDescription) right;
        ...
        {
            var target = (CommonEventResultDescription) "desc";
