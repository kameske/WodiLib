...
{
    [TestFixture]
    public class CommonEventSpecialArgCaseDescriptionTest
    {
        ...
        public static void ConstructorTest(string value, bool isError)
        {
            ...
            try
            {
                var _ = new CommonEventSpecialArgCaseDescription(value);
            }
            catch (Exception ex)
            {
                logger.Exception(ex);
        ...
        {
            var instance = new CommonEventSpecialArgCaseDescription(value);
        ...
        public static void CastToStringTest(string value)
        {
            ...
            var instance = value != null
                ? new CommonEventSpecialArgCaseDescription(value)
                : null;
        ...
        {
            CommonEventSpecialArgCaseDescription instance = null;
        ...
        {
            var leftIndex = (CommonEventSpecialArgCaseDescription)left;
            var rightIndex = (CommonEventSpecialArgCaseDescription)right;
        ...
        {
            var castedLeft = (CommonEventSpecialArgCaseDescription)left;
            var castedRight = (CommonEventSpecialArgCaseDescription)right;
            Assert.AreEqual(castedLeft.Equals(castedRight), isEqual);
        }
    }
}
