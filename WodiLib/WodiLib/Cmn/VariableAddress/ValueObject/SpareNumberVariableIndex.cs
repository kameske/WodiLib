...
namespace WodiLib.Cmn
{
    ...
    /// </summary>
    public struct SpareNumberVariableIndex : IConvertibleInt
    {
        ...
        /// <param name="right">右辺</param>
        /// <returns>左辺==右辺の場合true</returns>
        public static bool operator ==(SpareNumberVariableIndex left, int right)
        {
        ...
        public override bool Equals(object obj)
        {
            switch (obj)
            {
                case int other:
                    return other == Value;
                case SpareNumberVariableIndex other:
                    return this == other;
                default:
                    return false;
            }
