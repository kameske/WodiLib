...
namespace WodiLib.Cmn
{
    ...
    public class StringVariableAddress : VariableAddress
    {
        ...
        /// <summary>
        /// int -> StringVariableAddress への明示的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static explicit operator StringVariableAddress(int src)
        {
        ...
        /// <summary>
        /// StringVariableAddress -> int への明示的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static explicit operator int(StringVariableAddress src)
        {
            return src.Value;
        }
