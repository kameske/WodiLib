...
namespace WodiLib.Map
{
    ...
    ///     マップツリーノードリストクラス
    /// </summary>
    public class MapTreeNodeList : RestrictedCapacityList<MapTreeNode, MapTreeNodeList>
    {
        ...
        public MapTreeNodeList(IEnumerable<MapTreeNode> items) : base(items)
        {
        }
        ...
        public override bool ItemEquals(MapTreeNodeList? other)
        {
