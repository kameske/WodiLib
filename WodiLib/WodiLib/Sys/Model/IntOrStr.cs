...
namespace WodiLib.Sys
{
    ...
    public class IntOrStr : ModelBase<IntOrStr>
    {
        ...
        ///     かつコピー元の <see cref="InstanceIntOrStrType"/> が <see cref="IntOrStrType.None"/> または <see cref="IntOrStrType.Str"/>
        ///     の場合、
        ///     または <paramref name="instanceIntOrStrType"/> が <see cref="IntOrStrType.Str"/> または
        ///     <see cref="IntOrStrType.IntAndStr"/>
        ///     かつ <paramref name="strValue"/> が <see langword="null"/>
        ///     かつコピー元の <see cref="InstanceIntOrStrType"/> が <see cref="IntOrStrType.None"/> または <see cref="IntOrStrType.Int"/>
        ///     の場合、
        /// </exception>
