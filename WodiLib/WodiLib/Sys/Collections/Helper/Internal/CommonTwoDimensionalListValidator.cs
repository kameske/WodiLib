...
namespace WodiLib.Sys.Collections
{
    ...
    internal class CommonTwoDimensionalListValidator<TIn, TOut> : WodiLibTwoDimensionalListValidator<TIn, TOut>
        where TOut : TIn
    {
        protected override ITwoDimensionalListValidator<TIn, TOut>? BaseValidator => null;
        ...
        public override ITwoDimensionalListValidator<TIn, TOut> CreateAnotherFor(
            ITwoDimensionalList<TIn, TOut> target)
            => new CommonTwoDimensionalListValidator<TIn, TOut>(target, RowName, RowIndexName, ColumnName,
                ColumnIndexName);
