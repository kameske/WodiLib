...
// File Name    : ExtendedList.CollectionChangeEventArgsFactory.cs
//
...
namespace WodiLib.Sys.Collections
{
    ...
    {
        private class CollectionChangeEventArgsFactory
        {
            // _/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
            //     Public Static Method
            // _/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/

            public static CollectionChangeEventArgsFactory CreateSet(
            ...
            public static CollectionChangeEventArgsFactory CreateInsert(
                INotifyCollectionChange target, int index, IReadOnlyList<T> items)
                => new(target, NotifyCollectionChangedAction.Add, index, items);

            public static CollectionChangeEventArgsFactory CreateOverwrite(
            ...
            public static CollectionChangeEventArgsFactory CreateMove(
                INotifyCollectionChange target, int oldIndex, int newIndex,
                IReadOnlyList<T> items)
                => new(target, oldIndex, newIndex, items);

            public static CollectionChangeEventArgsFactory CreateRemove(
                INotifyCollectionChange target, int index, IReadOnlyList<T> items)
                => new(target, NotifyCollectionChangedAction.Remove, index, items);

            public static CollectionChangeEventArgsFactory CreateAdjustLengthIfShort(
                INotifyCollectionChange target, int index, IReadOnlyList<T> items)
                => new(target, true, index, items);

            public static CollectionChangeEventArgsFactory CreateAdjustLengthIfLong(
                INotifyCollectionChange target, int index, IReadOnlyList<T> items)
                => new(target, false, index, items);

            public static CollectionChangeEventArgsFactory CreateReset(
