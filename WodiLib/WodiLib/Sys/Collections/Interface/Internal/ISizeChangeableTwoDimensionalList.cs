...
namespace WodiLib.Sys.Collections
{
    ...
    internal interface ISizeChangeableTwoDimensionalList<TItem, TImpl, out TRowSizeChangeable,
        out TColumnSizeChangeable, out TWritable, out TReadable> :
        ...
        where TImpl : IReadableTwoDimensionalList<TItem, TImpl>, IEqualityComparable<TImpl>
    {
        ...
        /// </exception>
        public void AddRow(params IEnumerable<TItem>[] items);
        ...
        ///     または <paramref name="items"/> の要素数が <see cref="ColumnCount"/> と異なる場合。
        /// </exception>
        public void InsertRow(int rowIndex, params IEnumerable<TItem>[] items);
        ...
        /// </exception>
        public void OverwriteRow(int rowIndex, params IEnumerable<TItem>[] items);
        ...
        ///     自身を行数変更可能型にキャストする。
        /// </summary>
        /// <returns><typeparamref name="TRowSizeChangeable"/> にキャストした自分自身</returns>
        public TRowSizeChangeable AsRowSizeChangeableList();

        /// <summary>
        ///     自身を列数変更可能型にキャストする。
        /// </summary>
        /// <returns><typeparamref name="TColumnSizeChangeable"/> にキャストした自分自身</returns>
        public TColumnSizeChangeable AsColumnSizeChangeableList();
