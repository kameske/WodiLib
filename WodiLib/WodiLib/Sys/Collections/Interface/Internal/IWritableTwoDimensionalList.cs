...
namespace WodiLib.Sys.Collections
{
    ...
    [Obsolete]
    internal interface
        IWritableTwoDimensionalList<TItem, TImpl, out TReadable> :
            IEnumerable<IEnumerable<TItem>>, IEqualityComparable<TImpl>,
            INotifiableTwoDimensionalListChangeInternal<TItem>,
