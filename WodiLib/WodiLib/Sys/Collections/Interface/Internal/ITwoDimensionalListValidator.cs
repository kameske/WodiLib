...
namespace WodiLib.Sys.Collections
{
    ...
    internal interface ITwoDimensionalListValidator<TIn, TOut>
        where TOut : TIn
    {
        /// <summary>
        ///     コンストラクタの検証処理
        ...
        public void Constructor(TIn[][] iniTs);
        ...
        public void SetRow(int rowIndex, params IEnumerable<TIn>[] rows);
        ...
        public void SetItem(int rowIndex, int columnIndex, TIn item);
        ...
        ///     <see cref="ITwoDimensionalListValidator{TIn, TOut}"/> インスタンスを作成する。
        /// </summary>
        /// <param name="target">検証対象</param>
        /// <returns>新規検証処理インスタンス</returns>
        public ITwoDimensionalListValidator<TIn, TOut> CreateAnotherFor(ITwoDimensionalList<TIn, TOut> target);
    }
