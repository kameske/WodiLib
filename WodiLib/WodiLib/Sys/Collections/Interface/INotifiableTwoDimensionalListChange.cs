...
// File Name    : INotifiableTwoDimensionalListChange.cs
//
...
namespace WodiLib.Sys.Collections
{
        ...
        where TArgs : ITwoDimensionalCollectionChangeEventArgs<T>
    {
        ...
        ///     要素変更前通知
        /// </summary>
        public event EventHandler<TArgs> TwoDimensionalListChanging;

        /// <summary>
        ///     要素変更後通知
        /// </summary>
        public event EventHandler<TArgs> TwoDimensionalListChanged;
