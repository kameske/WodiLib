...
// File Name    : INotifyTwoDimensionalListChange.cs
//
...
namespace WodiLib.Sys.Collections
{
    ...
    /// </para>
    /// <para>
    ///     <see cref="NotifyTwoDimensionalListChangingEventType"/> や <see cref="NotifyTwoDimensionalListChangedEventType"/> に
    ...
    /// </para>
    /// </remarks>
    public interface INotifyTwoDimensionalListChange<T, TArgs>
        where TArgs : ITwoDimensionalCollectionChangeEventArgs<T>
    {
        /// <summary>
        ///     要素変更前通知
        /// </summary>
        public event EventHandler<T> TwoDimensionalListChanging;

        /// <summary>
        ///     要素変更後通知
        /// </summary>
        public event EventHandler<T> TwoDimensionalListChanged;
