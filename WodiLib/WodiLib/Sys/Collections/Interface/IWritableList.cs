...
namespace WodiLib.Sys.Collections
{
    ...
    public interface IWritableList<TItem, out TImpl, out TReadable> : IReadableList<TItem, TReadable>
        where TImpl : IWritableList<TItem, TImpl, TReadable>, IReadableList<TItem, TReadable>
