...
namespace WodiLib.Database
{
    ...
    public class DBItemSpecialSettingDesc : ModelBase<DBItemSpecialSettingDesc>
    {
        ...
        [Obsolete("DatabaseReferenceDesc プロパティを参照してください。Ver 2.6 で削除します。")]
        ...
        /// </summary>
        /// <exception cref="PropertyException">特殊指定が「ファイル読み込み」以外の場合</exception>
        [Obsolete("LoadFileDesc プロパティを参照してください。Ver 2.6 で削除します。")]
        ...
        [Obsolete("ManualDesc.AddSpecialCase(DatabaseValueCase) メソッドを使用してください。 Ver 2.6 で削除します。")]
        ...
        [Obsolete("ManualDesc.AddSpecialCaseRange(IEnumerable<DatabaseValueCase>) メソッドを使用してください。 Ver 2.6 で削除します。")]
        ...
        /// <exception cref="ArgumentNullException">argCasesがnullの場合</exception>
        [Obsolete("ManualDesc.InsertSpecialCase(int, DatabaseValueCase) メソッドを使用してください。 Ver 2.6 で削除します。")]
        ...
        [Obsolete("DatabaseReferenceDesc.UpdateDatabaseSpecialCase(int, string) メソッドを使用してください。 Ver 2.6 で削除します。")]
        ...
        /// <exception cref="ArgumentOutOfRangeException">indexが指定範囲外の場合</exception>
        /// <exception cref="ArgumentNullException">argCasesがnullの場合</exception>
        [Obsolete("ManualDesc.UpdateManualSpecialCase(int, DatabaseValueCase) メソッドを使用してください。 Ver 2.6 で削除します。")]
        ...
        /// <exception cref="InvalidOperationException">特殊指定が「手動生成」以外の場合</exception>
        /// <exception cref="ArgumentOutOfRangeException">indexが指定範囲外の場合</exception>
        [Obsolete("ManualDesc.RemoveSpecialCaseAt(int) メソッドを使用してください。 Ver 2.6 で削除します。")]
        ...
        [Obsolete("ManualDesc.RemoveSpecialCaseRange(int, int) メソッドを使用してください。 Ver 2.6 で削除します。")]
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">特殊指定が「手動生成」以外の場合</exception>
        [Obsolete("ManualDesc.ClearSpecialCase() メソッドを使用してください。 Ver 2.6 で削除します。")]
        public void Clear()
