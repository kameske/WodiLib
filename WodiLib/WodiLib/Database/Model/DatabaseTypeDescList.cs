...
namespace WodiLib.Database
{
    ...
    /// DB項目設定と設定値リスト
    /// </summary>
    public class DatabaseTypeDescList : RestrictedCapacityList<DatabaseTypeDesc, DatabaseTypeDescList>
    {
        ...
        public override bool ItemEquals(DatabaseTypeDescList? other)
        {
