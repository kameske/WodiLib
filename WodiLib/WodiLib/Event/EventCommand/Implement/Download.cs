...
namespace WodiLib.Event.EventCommand
{
    ...
    public class Download : EventCommandBase
    {
        ...
        private bool isStoreInVariable;

        /// <summary>変数に格納する。ラグ</summary>
        public bool IsStoreInVariable
        {
            get => isStoreInVariable;
            set
            {
                isStoreInVariable = value;
                NotifyPropertyChanged();
            }
        }

        private int pathStringVar;

        /// <summary>格納先の文字列変数</summary>
        public int PathStringVar
        {
            get => pathStringVar;
            set
            {
