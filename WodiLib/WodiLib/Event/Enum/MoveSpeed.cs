...
namespace WodiLib.Event
{
    ...
    public class MoveSpeed : TypeSafeEnum<MoveSpeed>
    {
        ...
        static MoveSpeed()
        {
            Slowest = new MoveSpeed("Slowest", 0x00);
            Slower = new MoveSpeed("Slower", 0x01);
            Slow = new MoveSpeed("Slow", 0x02);
            Normal = new MoveSpeed("Normal", 0x03);
            Fast = new MoveSpeed("Fast", 0x04);
            Faster = new MoveSpeed("Faster", 0x05);
            Fastest = new MoveSpeed("Fastest", 0x06);
        }
