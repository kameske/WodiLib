...
namespace WodiLib.Common
{
    ...
    /// </summary>
    [Serializable]
    public class CommonEventSpecialArgCaseList :
        RestrictedCapacityList<CommonEventSpecialArgCase, CommonEventSpecialArgCaseList>,
        IReadOnlyCommonEventSpecialArgCaseList
    {
        ...
        public string? GetDescriptionForCaseNumber(int caseNumber)
        {
            ...
            return info?.Description.RawValue;
        }
