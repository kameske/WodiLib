...
namespace WodiLib.Common
{
    ...
    public struct CommonEventSelfVariableIndex : IConvertibleInt, IEquatable<CommonEventSelfVariableIndex>
    {
        ...
        /// <summary>
        /// int -> CommonEventSelfVariableIndex への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator CommonEventSelfVariableIndex(int src)
        {
        ...
        /// <summary>
        /// CommonEventSelfVariableIndex -> int への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator int(CommonEventSelfVariableIndex src)
        {
            return src.Value;
        }
